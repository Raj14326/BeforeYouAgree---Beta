...
`clause_risk_score = 0.60 * model_probability_score + 0.40 * highest_category_severity_score`

To avoid missing obvious legal or privacy risks, the score also uses a minimum level:

- If a High-risk category is detected, the clause score is at least 75.
- If a Medium-risk category is detected, the clause score is at least 40.
...
- `predict_risk.py`: inference script for backend integration
